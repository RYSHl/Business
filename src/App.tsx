  ...
  return (
    <div className="site-shell">
      ...
      <main id="top">
        ...
        <section id="about" className="about section-pad section-light"><div className="section-intro"><SectionLabel>The opportunity</SectionLabel><h2>A business plan is<br /><span>just the beginning.</span></h2></div><div className="about-copy"><p className="lead-copy">VentureX 2026 - National Level Sustainable Innovation & Startup Pitch Competition is the flagship initiative of the Entrepreneurship Club, Birla Institute of Technology, Mesra - Noida Campus, themed "Innovating for a Sustainable Tomorrow." The event brings together students and young innovators from across the country to showcase business ideas focused on real-world sustainability challenges.
</p><p>More than a competition, VentureX is a platform where ideas meet opportunity. Participants will pitch to industry experts, entrepreneurs, and investors, gaining feedback, recognition, and opportunities for incubation and funding.

With 500+ expected participants over two days, the event connects students, startups, corporates, and

investors under one roof, fostering networking, mentorship, and industry exposure.

For sponsors, VentureX offers strong brand visibility, direct engagement with young talent, and association with a national-level sustainability-driven innovation platform shaping future entrepreneurs.</p><a className="text-link" href="#challenge">Discover the challenge <ArrowRight size={16} /></a></div><div className="about-stats"><div><b>01</b><span>Big idea<br />to business</span></div><div><b>04</b><span>People<br />per team</span></div><div><b>IN</b><span>Across India<br />invited</span></div></div></section>
...
<b>Dhrubajyoti Paul</b></div><div><small>PHONE</small><b>To be updated</b></div><div><small>EMAIL</small><b>To be updated</b></div><div><small>WEBSITE</small><b>edcbitmesra.in</b></div></div></section>
      ...
      <footer className="footer"><div className="footer-top"><a className="brand" href="#top"><span className="brand-mark"><Sparkles size={18} /></span><span><b>BUSINESS PLAN</b><small>BIT MESRA - NOIDA Campus · 2026</small></span></a><p>Pre-qualifier event of<br /><i>BIT-NISHAN</i></p><div className="socials"><a href="#contact" aria-label="Instagram"><Instagram size={18} /></a><a href="#contact" aria-label="LinkedIn"><Linkedin size={18} /></a><a href="#contact" aria-label="Facebook"><Facebook size={18} /></a><a href="#contact" aria-label="YouTube"><Youtube size={18} /></a></div></div><div className="footer-bottom"><span>© 2026 Business Plan · BIT Mesra</span><div><a href="#about">About</a><a href="#prizes">Prizes</a><a href="#registration">Register</a><a href="#contact">Contact</a></div><a href="#top">Back to top <ChevronDown size={15} className="rotate-180" /></a></div></footer>
    </div>
  );
}
