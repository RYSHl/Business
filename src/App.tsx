    ...
    <div className="site-shell">
      <header className="site-header">
        ...
        <nav className={menuOpen ? 'main-nav is-open' : 'main-nav'} aria-label="Main navigation">
          {['About us', 'Challenge', 'Prizes', 'Rules', 'Location'].map((item) => <a key={item} href={`#${item.toLowerCase()}`} onClick={closeMenu}>{item}</a>)}
...
<b>Dhrubajyoti Paul</b></div><div><small>PHONE</small><b>+91 70018 50166</b></div><div><small>EMAIL</small><b>shriiiistii@gmail.com</b></div><div>
  <small>WEBSITE</small>
  <b>
    <a
