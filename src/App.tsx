  ...
  return (
    <div className="site-shell">
      ...
      <main id="top">
        ...
        <section id="about" className="about section-pad section-light"><div className="section-intro"><SectionLabel>The opportunity</SectionLabel><h2>A business plan is<br /><span>just the beginning.</span></h2></div><div className="about-copy"><p className="lead-copy">Business Plan 2026 is a national startup innovation contest for the builders, thinkers and challengers ready to shape what comes next.</p><p>As the pre-qualifier to IIC-BIT’s flagship annual event, <i>BIT-NISHAN</i>, the experience brings ambitious student teams together to turn a sharp idea into a clear, compelling business case.</p><a className="text-link" href="#challenge">Discover the challenge <ArrowRight size={16} /></a></div><div className="about-stats"><div><b>01</b><span>Big idea<br />to business</span></div><div><b>04</b><span>People<br />per team</span></div><div><b>IN</b><span>Across India<br />invited</span></div></div></section>
        ...
        <section className="organizers section-pad"><div><SectionLabel>In collaboration with</SectionLabel><h2>Built by a community<br />that <span>believes.</span></h2></div><div className="org-list"><div><b>IIC</b><span>BIT Mesra</span></div><div><b>MMM CIE</b><span>Madan Mohan Mahanka Centre for Innovation & Entrepreneurship</span></div><div><b>EDC</b><span>Entrepreneurship Development Cell</span></div><div><b>FC</b><span>Finance Club, BIT Mesra</span></div></div></section>

        <section id="contact" className="contact section-pad section-light"><div><SectionLabel>Stay connected</SectionLabel><h2>Let’s build<br /><span>what’s next.</span></h2></div><div className="contact-fields"><div><small>CONTACT PERSON</small><b>To be updated</b></div><div><small>PHONE</small><b>To be updated</b></div><div><small>EMAIL</small><b>To be updated</b></div><div><small>WEBSITE</small><b>edcbitmesra.in</b></div></div></section>
      </main>
