...
<b>Dhrubajyoti Paul</b></div><div><small>PHONE</small><b>To be updated</b></div><div><small>EMAIL</small><b>To be updated</b></div><div><small>WEBSITE</small><b>edcbitmesra.in</b></div></div></section>
      ...
      <footer className="footer"><div className="footer-top"><a className="brand" href="#top"><span className="brand-mark"><Sparkles size={18} /></span><span><b>BUSINESS PLAN</b><small>BIT MESRA - NOIDA Campus · 2026</small></span></a><p><br /><i></i></p><div className="socials"><a href="https://www.instagram.com/bitnoidacampus/" aria-label="Instagram" target="_blank" rel="noopener noreferrer"><Instagram size={18} /></a><a href="#contact" aria-label="LinkedIn"><Linkedin size={18} /></a><a href="#contact" aria-label="Facebook"><Facebook size={18} /></a><a href="#contact" aria-label="YouTube"><Youtube size={18} /></a></div></div><div className="footer-bottom"><span>© 2026 Business Plan · BIT Mesra</span><div><a href="#about">About</a><a href="#prizes">Prizes</a><a href="#registration">Register</a><a href="#contact">Contact</a></div><a href="#top">Back to top <ChevronDown size={15} className="rotate-180" /></a></div></footer>
    </div>
  );
}
